<<parent_asymp_dep, echo=FALSE, cache=FALSE>>=
knitr::set_parent("C:/Users/Gabrielle/Google Drive/McGill - PhD/Thesis/dw-SM/JASA/Supplementary Material")
@

<<dep_asymptotic, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE>>=
library(hydroGOF)
...
est_psi1_500 <- read.table("est_dep30_psidWSurv1_500.txt")
n500 <- 1000 - sum(is.na(est_psi1_500[,1]))
se_psi1_500 <- read.table("se_dep30_psidWSurv1_500.txt")
...
est_psi1_1000 <- read.table("est_dep30_psidWSurv1_1000.txt")
n1000 <- 1000 - sum(is.na(est_psi1_1000[,1]))
se_psi1_1000 <- read.table("se_dep30_psidWSurv1_1000.txt")
...
est_psi1_10000 <- read.table("est_dep30_psidWSurv1_10000.txt")
n10000 <- 1000 - sum(is.na(est_psi1_10000[,1]))
se_psi1_10000 <- read.table("se_dep30_psidWSurv1_10000.txt")
...
est_psi2_500 <- read.table("est_dep30_psidWSurv2_500.txt")
se_psi2_500 <- read.table("se_dep30_psidWSurv2_500.txt")
...
est_psi2_1000 <- read.table("est_dep30_psidWSurv2_1000.txt")
se_psi2_1000 <- read.table("se_dep30_psidWSurv2_1000.txt")
...
est_psi2_10000 <- read.table("est_dep30_psidWSurv2_10000.txt")
se_psi2_10000 <- read.table("se_dep30_psidWSurv2_10000.txt")
...
est_60psi1_500 <- read.table("est_dep60_psidWSurv1_500.txt")
n500_60 <- 1000 - sum(is.na(est_60psi1_500[,1]))
se_60psi1_500 <- read.table("se_dep60_psidWSurv1_500.txt")
...
est_60psi1_1000 <- read.table("est_dep60_psidWSurv1_1000.txt")
n1000_60 <- 1000 - sum(is.na(est_60psi1_1000[,1]))
se_60psi1_1000 <- read.table("se_dep60_psidWSurv1_1000.txt")
...
est_60psi1_10000 <- read.table("est_dep60_psidWSurv1_10000.txt")
n10000_60 <- 1000 - sum(is.na(est_60psi1_10000[,1]))
se_60psi1_10000 <- read.table("se_dep60_psidWSurv1_10000.txt")
...
est_60psi2_500 <- read.table("est_dep60_psidWSurv2_500.txt")
se_60psi2_500 <- read.table("se_dep60_psidWSurv2_500.txt")
...
est_60psi2_1000 <- read.table("est_dep60_psidWSurv2_1000.txt")
se_60psi2_1000 <- read.table("se_dep60_psidWSurv2_1000.txt")
...
est_60psi2_10000 <- read.table("est_dep60_psidWSurv2_10000.txt")
se_60psi2_10000 <- read.table("se_dep60_psidWSurv2_10000.txt")
...
\begin{table}[H]
\centering
\caption{Comparison of Monte Carlo and standard errors calculated with the asymptotic variance, with 95\% Wald confidence interval coverage, in 1000 datasets with censoring dependent on baseline covariates.}
{\tabcolsep=4.25pt
