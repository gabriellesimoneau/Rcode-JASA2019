<<parent_compare_indep60, echo=FALSE, cache=FALSE>>=
knitr::set_parent("C:/Users/Gabrielle/Google Drive/McGill - PhD/Thesis/dw-SM/JASA/Supplementary Material")
@

<<compare_indep60, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE>>=
library(hydroGOF)
...
res_500 <- read.table("indep60_500.txt")
res_1000 <- read.table("indep60_1000.txt")
@
\begin{table}[H]
\centering
\caption{Summary of the log-survival time distribution under different treatment assignment schemes with 60\% independent censoring}
{\tabcolsep=4.25pt{
