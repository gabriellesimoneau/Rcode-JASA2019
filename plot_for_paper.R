###########################################################################
# Description:  This R script allows reproducing Figure 1 in the paper
#
...
#### Visualize bias in scenarios 1-4, n=1000, independent censoring 30% ####
ind30 <- "Bias_precision/Independent30/"
setwd(paste(mainpath, ind30, sep = ""))
...
png(paste(mainpath, "Figure1.png", sep = ""), height = 650, width = 800)
